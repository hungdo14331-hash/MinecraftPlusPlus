...
export const ABILITY_GUIDES: AbilityGuide[] = [
  ...
  { id:"mcpp:frostbite", name:"Băng Giá (Frostbite)", maxLevel:3, price:300, usage:"Mỗi đòn luôn làm chậm và có cơ hội đóng băng.", levels:["-10% 1s; 10% Freeze","-20% 1,5s; 15% Freeze","-30% 2s; 20% Freeze"] },
