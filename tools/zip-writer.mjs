// Zip writer toi gian, chi dung built-in Node.js (zlib) — khong goi lenh `zip` cua he
// dieu hanh, nen chay duoc tren ca Windows lan macOS/Linux ma khong can cai them gi.
...
/**
 * entries: [{ name: "BP/manifest.json", data: Buffer }, ...]
 * name luon dung "/" lam separator (chuan zip), bat ke he dieu hanh.
 * Tra ve 1 Buffer — tu ghi ra file bang writeFileSync o noi goi.
 */
